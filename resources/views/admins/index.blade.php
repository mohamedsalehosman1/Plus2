    ...
    <div class="main-content-inner">
        <div class="tf-section mb-10">
            ...
            <div class="wg-box">
                ...
                <a href="{{ route('admins.trash') }}" class="btn btn-secondary mb-3">{{ trans('admins.view_soft_deleted_admins') }}</a>

                <a href="{{ route('admins.create') }}" class="btn btn-primary mb-3">{{ trans('admins.create_new_admin') }}</a>
