                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($service->hasMedia('images'))
                                        <img src="{{ $service->getFirstMediaUrl('images') }}" alt="Ad Image" width="50"
                                            height="50">
                                    @else
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('services.create', ['parentId' => $service->id]) }}"
                                        class="btn btn-sm btn-primary" title="{{ trans('services.AddSubService') }}">
